...
Entre em contato com nosso suporte. Em períodos de alta demanda, o envio pode sofrer atrasos temporários.
      ...
      <section id="produtos" className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h3 className="text-3xl md:text-5xl font-black mb-4 break-words">
            🔥 COMPRE QUALQUER PRODUTO E GANHE UM <span className="text-green-400">PDF EXCLUSIVO COM MAIS DE 40 DICAS DE EMAGRECIMENTO 🔥</span>
          </h3>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="bg-zinc-950 border border-emerald-500/20 rounded-[32px] overflow-hidden shadow-[0_0_40px_rgba(16,185,129,0.1)]">
            <div className="p-8">
              ...
              <img src="/detox.png" alt="Detox" className="w-full my-8 rounded-3xl" />
        ...
        <div className="bg-gradient-to-r from-green-500/10 to-transparent border border-green-500/20 rounded-[40px] p-14 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-12">
              {["🔥 88 mil clientes já escolheram este produto", "⭐ 4,9/5 de Avaliação Média
👥 Mais de 83.000 Clientes Satisfeitos", "97% DE APROVAÇÃO", "ENTREGA RÁPIDA PARA TODO BRASIL"].map((item) => (
